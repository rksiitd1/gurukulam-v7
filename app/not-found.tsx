...
export default function NotFound() {
  return (
    <main className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-orange-50 via-green-50 to-blue-50 py-12 px-4 overflow-hidden">
      ...
      <Card className="max-w-2xl w-full text-center shadow-2xl border-orange-200 bg-white/80 backdrop-blur-md overflow-hidden transition-transform duration-300 hover:shadow-orange-200/80 hover:-translate-y-1">
        <CardHeader className="p-10">
          <div className="w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner">
            <Compass className="w-12 h-12 text-orange-500 animate-spin" style={{ animationDuration: '6s' }} />
          </div>
