      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8">
          <p className="text-xl md:text-2xl text-gray-700 font-light leading-relaxed italic">
            "Both the good (Shreyas) and the pleasant (Preyas) approach a person.
            <br/>The wise one, having examined both, discriminates.
            <br/>The wise one chooses the good over the pleasant.
            <br/>The fool, in order to acquire and preserve, chooses the pleasant."
          </p>
        </div>
        {/* Attribution */}
