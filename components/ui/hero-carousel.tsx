  ...
  return (
    <div className={cn("relative w-full overflow-hidden rounded-2xl shadow-2xl", className)}>
      ...
      <div className="relative w-full h-full">
        ...
        {/* Navigation Arrows - More compact and refined */}
        {images.length > 1 && (
          <>
            <button
              onClick={goToPrevious}
              className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/30 text-white w-8 h-8 flex items-center justify-center rounded-full transition-all duration-200 transform hover:scale-110 z-10"
            ...
            <button
              onClick={goToNext}
              className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/20 hover:bg-black/30 text-white w-8 h-8 flex items-center justify-center rounded-full transition-all duration-200 transform hover:scale-110 z-10"
