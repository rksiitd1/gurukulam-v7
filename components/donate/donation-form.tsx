      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea id="address" name="address" value={formData.address} onChange={handleInputChange} className="mt-1" rows={3} />
                  </div>
                  
                  <div className="flex items-start space-x-2">
                    <Checkbox id="terms" required />
                    <Label htmlFor="terms" className="text-sm leading-relaxed">
                      I agree to the <a href="/terms" target="_blank" className="text-orange-600 hover:underline">Terms of Service</a> and <a href="/privacy" target="_blank" className="text-orange-600 hover:underline">Privacy Policy</a>*
                    </Label>
                  </div>

                  <Button type="submit" size="lg" className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-lg py-6"
                    disabled={isSubmitting || (!amount && !customAmount) || !isRazorpayLoaded}>
                    {isSubmitting ? (
                      <><div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-2"></div>Processing...</>
                    ) : (
                      <><Lock className="w-5 h-5 mr-2" />Donate ₹{(customAmount || amount || "0").toLocaleString()} Securely</>
                    )}
                  </Button>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center"><Heart className="w-5 h-5 mr-2 text-red-600"/>Your Impact</CardTitle>
              </CardHeader>
              <CardContent className="text-sm space-y-2 text-gray-700">
                ...
                <p><strong>₹10,000:</strong> Helps fund a complete scholarship for one year.</p>
              </CardContent>
            </Card>

            <Card>
              <CardHeader>
                <CardTitle className="flex items-center"><CheckCircle className="w-5 h-5 mr-2 text-green-600" />Why Donate With Us?</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">Get tax deduction</div>
                    </div>
                  </div>
                   <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">Track your money's use</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-600">95% goes to programs</div>
                    </div>
                  </div>
                </div>
              </CardContent>
