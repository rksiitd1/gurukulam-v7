        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-2">
              <Image src="/DBM-logo.png" alt="Divya Bihar Mission Logo - Sun and Open Book Symbol" width={50} height={50} className="w-10 h-10 sm:w-12 sm:h-12 object-contain" loading="lazy" />
              <div>
